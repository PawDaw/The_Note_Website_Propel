...
class NoteTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Note', ),
        self::TYPE_CAMELNAME     => array('id', 'note', ),
        self::TYPE_COLNAME       => array(NoteTableMap::COL_ID, NoteTableMap::COL_NOTE, ),
        self::TYPE_FIELDNAME     => array('id', 'note', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Note' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'note' => 1, ),
        self::TYPE_COLNAME       => array(NoteTableMap::COL_ID => 0, NoteTableMap::COL_NOTE => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'note' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setPrimaryKeyMethodInfo('note_id_seq');
        // columns
