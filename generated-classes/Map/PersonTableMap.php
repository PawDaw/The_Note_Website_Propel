...
class PersonTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Pass', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'pass', ),
        self::TYPE_COLNAME       => array(PersonTableMap::COL_ID, PersonTableMap::COL_NAME, PersonTableMap::COL_PASS, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'pass', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Pass' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'pass' => 2, ),
        self::TYPE_COLNAME       => array(PersonTableMap::COL_ID => 0, PersonTableMap::COL_NAME => 1, PersonTableMap::COL_PASS => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'pass' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    {
        $this->addRelation('Person_note', '\\Person_note', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':person_id',
    1 => ':id',
  ),
), null, null, 'Person_notes', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PersonTableMap::COL_PASS);
        } else {
