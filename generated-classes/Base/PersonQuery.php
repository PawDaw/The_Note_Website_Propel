 ...
 * @method     ChildPersonQuery orderByPass($order = Criteria::ASC) Order by the pass column
 *
 * @method     ChildPersonQuery groupById() Group by the id column
 * @method     ChildPersonQuery groupByName() Group by the name column
 * @method     ChildPersonQuery groupByPass() Group by the pass column
 *
 ...
 *
 * @method     ChildPersonQuery leftJoinPerson_note($relationAlias = null) Adds a LEFT JOIN clause to the query using the Person_note relation
 * @method     ChildPersonQuery rightJoinPerson_note($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Person_note relation
 * @method     ChildPersonQuery innerJoinPerson_note($relationAlias = null) Adds a INNER JOIN clause to the query using the Person_note relation
 *
 * @method     ChildPersonQuery joinWithPerson_note($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Person_note relation
 *
 * @method     ChildPersonQuery leftJoinWithPerson_note() Adds a LEFT JOIN clause and with to the query using the Person_note relation
 * @method     ChildPersonQuery rightJoinWithPerson_note() Adds a RIGHT JOIN clause and with to the query using the Person_note relation
 * @method     ChildPersonQuery innerJoinWithPerson_note() Adds a INNER JOIN clause and with to the query using the Person_note relation
 *
 ...
 * @method     ChildPerson findOneByPass(string $pass) Return the first ChildPerson filtered by the pass column *
 ...
 * @method     ChildPerson requireOneByPass(string $pass) Return the first ChildPerson filtered by the pass column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPerson[]|ObjectCollection findByPass(string $pass) Return ChildPerson objects filtered by the pass column
...
abstract class PersonQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, pass FROM person WHERE id = :p0';
        try {
    ...
    public function filterByPass($pass = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PersonTableMap::COL_PASS, $pass, $comparison);
    }
    ...
    public function filterByPerson_note($person_note, $comparison = null)
    {
        if ($person_note instanceof \Person_note) {
            return $this
                ->addUsingAlias(PersonTableMap::COL_ID, $person_note->getPersonId(), $comparison);
