...
/**
 * Base class that represents a row from the 'person_note' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Person_note implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\Person_noteTableMap';
    ...
    /**
     * Initializes internal state of Base\Person_note object.
     */
    ...
    /**
     * Compares this with another <code>Person_note</code> instance.  If
     * <code>obj</code> is an instance of <code>Person_note</code>, delegates to
     * <code>equals(Person_note)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Person_note The current object, for fluid interface
     */
     ...
     * @return $this|\Person_note The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[Person_noteTableMap::COL_ID] = true;
        }
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[Person_noteTableMap::COL_PERSON_ID] = true;
        }
    ...
    public function setNoteId($v)
    {
        ...
        if ($this->note_id !== $v) {
            $this->note_id = $v;
            $this->modifiedColumns[Person_noteTableMap::COL_NOTE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : Person_noteTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : Person_noteTableMap::translateFieldName('PersonId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->person_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : Person_noteTableMap::translateFieldName('NoteId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = Person_noteTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Person_note'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPerson_noteQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Person_note::setDeleted()
     * @see Person_note::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPerson_noteQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                Person_noteTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('person_note_id_seq')");
        ...
        if ($this->isColumnModified(Person_noteTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(Person_noteTableMap::COL_PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = 'person_id';
        }
        if ($this->isColumnModified(Person_noteTableMap::COL_NOTE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'note_id';
        }

        $sql = sprintf(
            'INSERT INTO person_note (%s) VALUES (%s)',
    ...
    {
        $pos = Person_noteTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Person_note'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Person_note'][$this->hashCode()] = true;
        $keys = Person_noteTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(Person_noteTableMap::COL_ID)) {
            $criteria->add(Person_noteTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(Person_noteTableMap::COL_PERSON_ID)) {
            $criteria->add(Person_noteTableMap::COL_PERSON_ID, $this->person_id);
        }
        if ($this->isColumnModified(Person_noteTableMap::COL_NOTE_ID)) {
            $criteria->add(Person_noteTableMap::COL_NOTE_ID, $this->note_id);
        }
    ...
    {
        $criteria = ChildPerson_noteQuery::create();
        $criteria->add(Person_noteTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Person_note (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Person_note Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPerson(ConnectionInterface $con = null)
    {
        if ($this->aPerson === null && ($this->person_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPerson->addPerson_notes($this);
             */
        }
    ...
    public function getNote(ConnectionInterface $con = null)
    {
        if ($this->aNote === null && ($this->note_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aNote->addPerson_notes($this);
             */
        }
    ...
    {
        if (null !== $this->aPerson) {
            $this->aPerson->removePerson_note($this);
        }
        if (null !== $this->aNote) {
            $this->aNote->removePerson_note($this);
        }
        $this->id = null;
        $this->person_id = null;
        $this->note_id = null;
    ...
    {
        return (string) $this->exportTo(Person_noteTableMap::DEFAULT_STRING_FORMAT);
    }
